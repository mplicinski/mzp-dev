...
const projectData = [
  {
    ...
    description: "A personal website to showcase my portfolio. Built using Next.js and Tailwind",
  ...
  {
    id: 2,
    title: "Guardian Agency Insurance Agency Website",
    description: "An informational website for an independant insurance agency. Built using Django ",
  ...
  },
  {
    ...
    description: "Team project where I contributed documentation, design, frontend development, binding, and a job matching algorithm",
